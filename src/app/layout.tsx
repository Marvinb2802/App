...
export const metadata: Metadata = {
  title: "Strava KI-Coach",
  description:
    "Verbinde Strava, lass dein Training von Claude auswerten und erhalte einen Trainingsplan, der zu deinen echten Daten passt.",
};
  ...
  return (
    <html lang="de">
      <body className="font-sans antialiased">
        <header className="sticky top-0 z-20 border-b border-ink-800/80 bg-ink-950/85 backdrop-blur">
          <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-6 gap-y-3 px-5 py-3">
            <Link href="/" className="flex items-center gap-2.5 font-semibold tracking-tight">
              <span className="grid h-8 w-8 place-items-center rounded-lg bg-strava text-sm font-bold text-white">
                KI
              </span>
              <span>Strava&nbsp;KI-Coach</span>
            </Link>
        ...
        <footer className="mx-auto max-w-6xl px-5 pb-10 pt-4 text-xs leading-relaxed text-ink-500">
